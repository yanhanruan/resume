...
\Large{
  \begin{tabu}{ c l r }
   \multirow{5}{1in}{\includegraphics[width=0.88in]{avatar}} & \scshape{Ruan Yanhan} & \pbar{React}{0.8} \\
...
\begin{itemize}[parsep=0.5ex]
  \item Proficient in reading English documents, CET-6 (539), preparing for N3 exam.
\end{itemize}
